...
// URL do webhook específico para Mercado e Público Alvo
export const WEBHOOK_URL = import.meta.env.VITE_MARKET_TARGET_WEBHOOK_URL || 'https://mkseo77.app.n8n.cloud/webhook/mercado-alvo';
