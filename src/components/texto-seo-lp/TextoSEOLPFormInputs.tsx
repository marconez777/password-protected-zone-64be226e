...
import { TextoSEOLPFormData } from "./TextoSEOLPSchema";

export function TextoSEOLPFormInputs() {
  const { control } = useFormContext<TextoSEOLPFormData>();
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="text-base">
              Tema do artigo <span className="text-red-500">*</span>
            </FormLabel>
            <FormControl>
              <Input 
