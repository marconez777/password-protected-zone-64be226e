...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-76px)] overflow-hidden">
      ...
      {/* Purple abstract shapes - further adjusted positions */}
      <div className="absolute top-[10%] left-[10%] w-[300px] h-[300px] bg-[#805af5] rounded-full blur-[100px] opacity-20"></div>
      <div className="absolute bottom-[10%] left-[40%] w-[200px] h-[200px] bg-[#cd99ff] rounded-full blur-[80px] opacity-20"></div>
      ...
      <div className="container mx-auto px-4 pt-20 pb-16 relative z-10 text-center flex flex-col items-center justify-center min-h-[calc(100vh-76px)]">
        ...
        <h2 className={`text-transparent bg-clip-text bg-gradient-to-b from-[#805af5] to-[#cd99ff] text-6xl md:text-7xl lg:text-8xl font-bold mb-8 transition-opacity duration-500 ${isAnimating ? 'opacity-0' : 'opacity-100'} w-full px-8 mx-8 overflow-visible`}>
          {currentText}
        </h2>
