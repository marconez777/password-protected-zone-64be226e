...
const AssinarPricing = () => {
  ...
  return (
    <div className="w-full py-24 bg-[#0c0a11]" id="pricing-section">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            <span className="text-[#805af5]">💡</span> Escolha seu Plano e Comece Agora
          </h2>
          <p className="text-gray-400 text-lg">
            Invista em uma estratégia que realmente funciona
          </p>
        </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="mt-auto">
                <Button className="w-full bg-[#805af5] hover:bg-[#6a4ac9] text-white" asChild>
                  <Link to="/cadastro">
                    Quero Economizar e Começar Agora
                  </Link>
                </Button>
                <p className="text-center text-xs text-gray-500 mt-3">Oferta por tempo limitado</p>
              </div>
